        ...
        <div className="blog__container container grid">
            <div className="blog__item card card-two">
                ...
                <p className="blog__description">
                    ...
                    Aliquam vel sem vel velit efficitur malesuada. Donec arcu lacus, ornare eget...
                </p>

                <a href="" className="link">
                    Read More <FaArrowRight className='link__icon'></FaArrowRight>
                </a>
            ...
            <div className="blog__item card card-two">
                <span className="blog__date text-cs">NOVEMBER 17, 2023</span>
            ...
            <div className="blog__item card card-two">
                <span className="blog__date text-cs">DECEMBER 10, 2023</span>
